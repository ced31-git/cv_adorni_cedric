...
const About = () => {
  return (
    <div name="about" className="w-full h-screen bg-darkblue text-slate-100">
        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
          ...
          <div>
            ...
            <p>
              ...
              que l'on <span className="font-bold italic">programmait</span> afin d'usiner les pièces que
              l'on souhaitait à plus ou moins grande série.
            </p>
            <p>
            ...
            <p>Pour finir, je reviens à mes premières amours qui n'est pas moins le monde de la programmation. </p>
          </div>
        </div>
      </div>
    </div>
